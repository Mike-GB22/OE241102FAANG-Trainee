//2024.11.02
// Каждый элемент массива представляет собой объем переданных данных за определенный временной интервал.
// Необходимо определить максимальный объем передачи данных за все временные интервалы.
